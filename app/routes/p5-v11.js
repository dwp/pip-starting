module.exports = function (app) {
  ...
  app.get('/p5-v11/list-1', (req, res, next) => {
    ...
    res.render('p5-v11/list-1.html', {sectionStatus: req.session.sectionStatus, sectionCount: req.session.sectionCount});
  });

  // Clear data on the 'application cancelled' screen

  app.get('/*/clear-p5-v11-1', function (req, res) {
    req.session.destroy()
    res.render('p5-v11/application-cancelled')
  })


  // Routes

  app.get('/p5-v11/sign-in/answer-choice', function(req, res) {
  ...
  app.get('/p5-v11/sign-in/intro-question-answer', function(req, res) {
  ...
  app.get('/p5-v11/about-your-health/another-answer', function(req, res) {
  ...
  app.get('/p5-v11/about-your-health/another-2-answer', function(req, res) {
  ...
  app.get('/p5-v11/about-your-health-professionals/q-health-professional-answer', function(req, res) {
  ...
  app.get('/p5-v11/about-your-health-professionals/another-answer', function(req, res) {
  ...
  app.get('/p5-v11/about-your-health-professionals/another-2-answer', function(req, res) {
  ...
  app.get('/p5-v11/preparing-food/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/eating-and-drinking/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/managing-treatments/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/washing-and-bathing/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/managing-toilet-needs/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/dressing-and-undressing/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/talking-and-listening/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/reading/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/mixing-with-other-people/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/managing-money/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/planning-and-following-a-journey/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/moving-around/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/additional-information/index-answer', function(req, res) {
  ...
  app.get('/p5-v11/apply/pdf-answer', function(req, res) {
  ...
  app.get('/p5-v11/supporting-evidence/supporting-evidence-data', function(req, res) {
    ...
    if (question === 'yes') {
        ...
        res.redirect('/p5-v11/apply/declaration')
      }
  });

  app.get('/p5-v11/supporting-evidence/supporting-evidence-uploaded-1-data', function(req, res) {
  ...
  app.get('/p5-v11/supporting-evidence/supporting-evidence-uploaded-2-data', function(req, res) {
  ...
  app.get('/p5-v11/supporting-evidence/supporting-evidence-uploaded-3-data', function(req, res) {
  ...
  app.get('/p5-v11/supporting-evidence/uploading-supporting-evidence-1', function(req, res) {
    res.render('p5-v11/supporting-evidence/uploading', { 'file' : 'supporting-evidence-1' });
  });

  app.get('/p5-v11/supporting-evidence/uploading-supporting-evidence-2', function(req, res) {
    res.render('p5-v11/supporting-evidence/uploading', { 'file' : 'supporting-evidence-2' });
  });

  app.get('/p5-v11/supporting-evidence/uploading-supporting-evidence-3', function(req, res) {
    res.render('p5-v11/supporting-evidence/uploading', { 'file' : 'supporting-evidence-3' });
  });

// // Coming back uploading evidence

//   app.get('/p5-v11/coming-back/supporting-evidence-uploaded-1', function(req, res) {

//     let question = req.session.data['question']

//     if (question === 'yes') {
//         res.redirect('/p5-v11/coming-back/supporting-evidence-upload-2')
//       } else {
//         res.redirect('/p5-v11/coming-back/confirmation-returning')
//       }
//   });
  ...
  app.get('/p5-v11/supporting-evidence/upload-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/upload', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/uploading-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/uploading', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/uploaded-1-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/uploaded-1', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/supporting-evidence-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/supporting-evidence', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/supporting-evidence-data-cya', function(req, res) {
  ...
  app.get('/p5-v11/supporting-evidence/interruption-screen-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/interruption-screen', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/supporting-evidence-upload-1-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/supporting-evidence-upload-1', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence-upload-2-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence-upload-2', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/supporting-evidence-upload-3-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/supporting-evidence-upload-3', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/uploading-supporting-evidence-1-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/uploading', { 'file' : 'supporting-evidence-1', 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/uploading-supporting-evidence-2-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/uploading', { 'file' : 'supporting-evidence-2', 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/uploading-supporting-evidence-3-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/uploading', { 'file' : 'supporting-evidence-3', 'cya' : 'true' });
  });
  ...
  app.get('/p5-v11/supporting-evidence/supporting-evidence-upload-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/supporting-evidence-upload-2', { 'cya' : 'true' });
  });
  ...
  app.get('/p5-v11/supporting-evidence/supporting-evidence-uploaded-1-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/supporting-evidence-uploaded-1', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/supporting-evidence-uploaded-2-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/supporting-evidence-uploaded-2', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/supporting-evidence-uploaded-3-cya', function(req, res) {
    res.render('p5-v11/supporting-evidence/supporting-evidence-uploaded-3', { 'cya' : 'true' });
  });

  app.get('/p5-v11/supporting-evidence/supporting-evidence-uploaded-1-data-cya', function(req, res) {
  ...
  app.get('/p5-v11/supporting-evidence/supporting-evidence-uploaded-2-data-cya', function(req, res) {
  ...
  app.get('/p5-v11/supporting-evidence/supporting-evidence-uploaded-3-data-cya', function(req, res) {
