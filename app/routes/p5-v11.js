module.exports = function (app) {
  ...
  app.get('/p5-rev-1/list-1', (req, res, next) => {
    ...
    res.render('p5-rev-1/list-1.html', {sectionStatus: req.session.sectionStatus, sectionCount: req.session.sectionCount});
  });
  ...
  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-data', function(req, res) {
    ...
    if (question === 'yes') {
        ...
        res.redirect('/p5-rev-1/apply/declaration')
      }
  });
