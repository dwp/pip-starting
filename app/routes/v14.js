...
module.exports = function (router) {
    ...
    router.post('/v14/alt-formats-choice', (req, res, next) => {
        ...
        if (altFormat === 'Braille') {
            ...
            res.redirect('/v14/alt-formats-paper');
        }
    ...
    router.post('/v14/about_your_health/hcp-1', (req, res, next) => {
        res.redirect('/v14/about_your_health/hcp-another');
    });
    ...
    router.post('/v14/contact-details', (req, res, next) => {
        res.redirect('/v14/bank-account.html')
    })
