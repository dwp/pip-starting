module.exports = function (app) {
  ...
  app.get('/p5-rev-1/list', (req, res, next) => {
  ...
  app.get('/p5-rev-1/sign-in/answer-choice', function(req, res) {
  ...
  app.get('/p5-rev-1/sign-in/intro-question-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/about-your-health/another-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/about-your-health/another-2-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/about-your-health-professionals/q-health-professional-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/about-your-health-professionals/another-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/about-your-health-professionals/another-2-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/preparing-food/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/eating-and-drinking/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/managing-treatments/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/washing-and-bathing/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/managing-toilet-needs/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/dressing-and-undressing/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/talking-and-listening/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/reading/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/mixing-with-other-people/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/managing-money/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/planning-and-following-a-journey/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/moving-around/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/additional-information/index-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/apply/pdf-answer', function(req, res) {
  ...
  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-data', function(req, res) {
    ...
    if (question === 'yes') {
        ...
        res.redirect('/mvp-rev-1/p5-rev-1/apply/declaration')
      }
  });

  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-uploaded-1-data', function(req, res) {
  ...
  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-uploaded-2-data', function(req, res) {
  ...
  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-uploaded-3-data', function(req, res) {
  ...
  app.get('/p5-rev-1/supporting-evidence/uploading-supporting-evidence-1', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/uploading', { 'file' : 'supporting-evidence-1' });
  });

  app.get('/p5-rev-1/supporting-evidence/uploading-supporting-evidence-2', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/uploading', { 'file' : 'supporting-evidence-2' });
  });

  app.get('/p5-rev-1/supporting-evidence/uploading-supporting-evidence-3', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/uploading', { 'file' : 'supporting-evidence-3' });
  });

// // Coming back uploading evidence

//   app.get('/p5-rev-1/coming-back/supporting-evidence-uploaded-1', function(req, res) {

//     let question = req.session.data['question']

//     if (question === 'yes') {
//         res.redirect('/p5-rev-1/coming-back/supporting-evidence-upload-2')
//       } else {
//         res.redirect('/p5-rev-1/coming-back/confirmation-returning')
//       }
//   });
  ...
  app.get('/p5-rev-1/supporting-evidence/upload-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/upload', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/uploading-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/uploading', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/uploaded-1-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/uploaded-1', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/supporting-evidence', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-data-cya', function(req, res) {
  ...
  app.get('/p5-rev-1/supporting-evidence/interruption-screen-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/interruption-screen', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-upload-1-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/supporting-evidence-upload-1', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence-upload-2-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence-upload-2', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-upload-3-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/supporting-evidence-upload-3', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/uploading-supporting-evidence-1-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/uploading', { 'file' : 'supporting-evidence-1', 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/uploading-supporting-evidence-2-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/uploading', { 'file' : 'supporting-evidence-2', 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/uploading-supporting-evidence-3-cya', function(req, res) {
  ...
  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-upload-cya', function(req, res) {
  ...
  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-uploaded-1-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/supporting-evidence-uploaded-1', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-uploaded-2-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/supporting-evidence-uploaded-2', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-uploaded-3-cya', function(req, res) {
    res.render('p5-rev-1/supporting-evidence/supporting-evidence-uploaded-3', { 'cya' : 'true' });
  });

  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-uploaded-1-data-cya', function(req, res) {
  ...
  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-uploaded-2-data-cya', function(req, res) {
  ...
  app.get('/p5-rev-1/supporting-evidence/supporting-evidence-uploaded-3-data-cya', function(req, res) {
